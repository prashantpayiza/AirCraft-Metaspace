...
public class AirplaneController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            isAirCraftLiftUp = true;
            SetThrust(thrustPercent + thrustControlSensitivity);
            Debug.Log($"this is  thrustPercent and value is {thrustPercent} and sensitivity value is {thrustControlSensitivity}");
        }

       // Debug.Log($"this is update value");
    ...
    {
        thrustPercent = 1;//Mathf.Clamp01(percent);
    }
